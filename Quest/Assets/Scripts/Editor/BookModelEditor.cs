...
namespace QG.Editor {
    ...
    [CustomEditor(typeof(BookModel))]
    public class BookModelEditor : Editor {
        ReorderableList list;
        Texture tex;
        private void OnEnable() {
            tex = AssetDatabase.LoadAssetAtPath("Assets\\Resources\\Images\\UI\\replace.png", typeof(Texture)) as Texture;
            if (tex == null) {
            ...
            list.onRemoveCallback = (ReorderableList l) => {
                if (EditorUtility.DisplayDialog("Warning!",
                    ...
                    BookModel book = target as BookModel;
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Update Pages Order")) {
                ( target as BookModel ).UpdatePages();
            }
